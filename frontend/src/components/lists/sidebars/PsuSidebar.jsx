...
const formFactors = ["ATX", "SFX", "SFX-L", "TFX", "FlexATX"];
const certifications = ["80+ White", "80+ Bronze", "80+ Silver", "80+ Gold", "80+ Platinum", "80+ Titanium"];
const brands = [
  "Corsair",
  "EVGA",
  "Seasonic",
...
export default function PsuSidebar({ onApply }) {
  ...
  const filterSections = [
    ...
    },
    {
      ...
      content: (
        <>
          {sliderWithInputs("wattage", "Wattage", 300, 1600, "W")}
          {sliderWithInputs("psuLength", "PSU Length", 100, 200, "mm")}
        </>
      ),
    },
    {
    ...
    },
    {
      id: "certification",
      title: "Certification",
      content: checkboxList("certifications", certifications),
    },
    {
      id: "brands",
      title: "Brands",
