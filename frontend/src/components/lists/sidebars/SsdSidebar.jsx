...
const formFactors = ["M.2 2280", "M.2 2230", "M.2 2242", "2.5-inch", "U.2", "Add-in Card"];
const pcieGens = ["PCIe 3.0", "PCIe 4.0", "PCIe 5.0", "SATA III"];
const capacities = ["250GB", "500GB", "1TB", "2TB", "4TB", "8TB"];
const brands = [
  "Samsung",
  "Western Digital",
  "Crucial",
...
export default function SsdSidebar({ onApply }) {
  ...
  const filterSections = [
    ...
    },
    {
      ...
      content: (
        <>
          {sliderWithInputs("seqRead", "Sequential Read", 500, 7000, "MB/s")}
          {sliderWithInputs("seqWrite", "Sequential Write", 400, 6000, "MB/s")}
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      content: checkboxList("pcieGens", pcieGens),
    },
    {
      id: "brands",
      title: "Brands",
      ...
      content: (
        <div className="space-y-2">
          <label className="flex items-center space-x-2">
            <input
              type="checkbox"
              checked={filters.dramCache}
              onChange={() => handleSingleCheckbox("dramCache")}
              className="h-4 w-4 text-blue-500 bg-gray-800 border-gray-600 rounded focus:ring-blue-500 focus:ring-offset-gray-800"
            />
            <span className="text-sm text-gray-300">DRAM Cache</span>
          </label>
        </div>
      ),
    },
