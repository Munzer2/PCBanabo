...
export default function MotherboardSidebar({
  onApply,
  formFactors = ["ATX", "Micro-ATX", "Mini-ITX", "E-ATX"],
  sockets = ["AM4", "AM5", "LGA1700", "LGA1200"],
  chipsets = ["B550", "X570", "Z690", "Z790", "B660"],
  memTypes = ["DDR4", "DDR5"]
}) {
  ...
  const filterSections = [
    {
      id: "price",
      title: "Price Range",
      content: sliderWithInputs("price", "Price", 0, 1000, "$"),
    },
    {
      id: "memSpeed",
      title: "Memory Speed",
      content: sliderWithInputs("memSpeed", "Memory Speed", 2000, 6000, "MHz"),
    },
    {
      id: "formFactor",
      title: "Form Factor",
      content: checkboxList("formFactors", formFactors),
    },
    {
      id: "socket",
      title: "Socket",
      content: checkboxList("sockets", sockets),
    },
    {
      id: "chipset",
      title: "Chipset",
      content: checkboxList("chipsets", chipsets),
    },
    {
      id: "memType",
      title: "Memory Type",
      content: checkboxList("memTypes", memTypes),
    },
    {
      id: "features",
      title: "Features",
        ...
        <div className="space-y-2">
          <label className="flex items-center space-x-2">
            <input
              ...
              onChange={() => handleSingleCheckbox("wifi")}
              className="h-4 w-4 text-blue-500 bg-gray-800 border-gray-600 rounded focus:ring-blue-500 focus:ring-offset-gray-800"
            />
          ...
          <label className="flex items-center space-x-2">
            <input
              ...
              onChange={() => handleSingleCheckbox("bluetooth")}
              className="h-4 w-4 text-blue-500 bg-gray-800 border-gray-600 rounded focus:ring-blue-500 focus:ring-offset-gray-800"
            />
          ...
          <label className="flex items-center space-x-2">
            <input
              type="checkbox"
              checked={filters.thunderbolt}
              onChange={() => handleSingleCheckbox("thunderbolt")}
              className="h-4 w-4 text-blue-500 bg-gray-800 border-gray-600 rounded focus:ring-blue-500 focus:ring-offset-gray-800"
            />
            <span className="text-sm text-gray-300">Thunderbolt</span>
          </label>
        </div>
      ),
    },
