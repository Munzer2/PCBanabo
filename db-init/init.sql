...
--
-- Name: casing; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.casing (
    ...
    motherboard_support character varying(100) NOT NULL,
    psu_clearance integer NOT NULL,
    gpu_clearance integer NOT NULL,
    cpu_clearance integer NOT NULL,
    top_rad_support character varying(100),
    bottom_rad_support character varying(100),
    side_rad_support character varying(100),
...
--
-- Name: casing_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: casing_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.cpu (
    ...
    tdp integer,
    cache_size character varying(50),
...
--
-- Name: cpu_cooler; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.cpu_cooler (
    ...
    brand_name character varying(50) NOT NULL,
    model_name character varying(100) NOT NULL,
    socket_support character varying(200) NOT NULL,
...
--
-- Name: cpu_cooler_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: cpu_cooler_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: cpu_new_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: cpu_new_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.gpu (
    ...
    brand_name character varying(50) NOT NULL,
    model_name character varying(100) NOT NULL,
    gpu_core character varying(50) NOT NULL,
    vram integer NOT NULL,
    tdp integer NOT NULL,
    power_connector_type character varying(50) NOT NULL,
    power_connector_count integer NOT NULL,
    card_length integer NOT NULL,
    card_height integer NOT NULL,
    card_thickness numeric(2,1) NOT NULL,
    rgb boolean,
    avg_price numeric(10,2) NOT NULL,
    official_product_url text
);
...
CREATE TABLE public.motherboard (
    ...
    form_factor character varying(10) NOT NULL,
    ...
    lan_speed character varying(10) NOT NULL,
    wifi_version character varying(10),
    bluetooth_version character varying(10),
    usb_2_ports integer NOT NULL,
    usb_3_ports integer NOT NULL,
    usb_c_ports integer NOT NULL,
    thunderbolt_ports integer,
    max_power integer,
    opt_feature character varying(200),
...
--
-- Name: saved_builds; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.saved_builds (
    ...
    build_name character varying(100),
...
--
-- Name: saved_builds_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: saved_builds_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: ssd; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.ssd (
    ...
    pcie_gen character varying(10) NOT NULL,
    seq_read integer,
    seq_write integer,
    dram_cache boolean,
    avg_price numeric(10,2) NOT NULL,
...
--
-- Name: ssd_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: ssd_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.user_info (
    ...
    enc_password character(16) NOT NULL
);
...
--
-- Name: casing id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: cpu_cooler id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: saved_builds id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: ssd id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: casing casing_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cpu_cooler cpu_cooler_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cpu cpu_new_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: saved_builds saved_builds_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ssd ssd_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: saved_builds saved_builds_casing_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: saved_builds saved_builds_cpu_cooler_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: saved_builds saved_builds_cpu_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: saved_builds saved_builds_gpu_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: saved_builds saved_builds_motherboard_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: saved_builds saved_builds_psu_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: saved_builds saved_builds_ram_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: saved_builds saved_builds_ssd_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: saved_builds saved_builds_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Data for Name: casing; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.casing VALUES (8, 'Fractal Design', 'Casing-327', 'Mini-ITX', 169, 379, 168, '240mm', '360mm', NULL, 2, true, false, 'Black', 59.00, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (14, 'Fractal Design', 'Casing-271', 'Micro-ATX', 215, 341, 174, NULL, '240mm', NULL, 4, false, true, 'Black', 214.60, 'https://example.com/casing');
INSERT INTO public.casing VALUES (15, 'Corsair', 'Casing-241', 'ATX', 194, 324, 173, NULL, '360mm', NULL, 2, false, true, 'Black', 186.10, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (34, 'NZXT', 'Casing-835', 'Micro-ATX', 185, 308, 167, '360mm', '360mm', NULL, 1, false, true, 'Silver', 178.90, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (37, 'Cooler Master', 'Casing-853', 'Mini-ITX', 174, 289, 175, '240mm', NULL, '360mm', 4, true, true, 'Black', 295.40, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (42, 'NZXT', 'Casing-947', 'ATX', 161, 352, 156, '240mm', NULL, '240mm', 1, false, true, 'Silver', 142.80, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (47, 'Fractal Design', 'Casing-350', 'ATX', 218, 293, 177, '240mm', NULL, '280mm', 1, true, true, 'White', 75.00, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (69, 'Lian Li', 'Casing-163', 'Micro-ATX', 213, 330, 160, '240mm', '240mm', '240mm', 2, false, true, 'Silver', 297.90, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (74, 'NZXT', 'Casing-876', 'Mini-ITX', 220, 400, 173, '360mm', '280mm', '360mm', 4, true, true, 'Black', 107.90, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (88, 'Lian Li', 'Casing-319', 'Micro-ATX', 185, 324, 173, NULL, '360mm', '280mm', 3, false, false, 'Black', 190.90, 'https://example.com/casing');
INSERT INTO public.casing VALUES (89, 'Cooler Master', 'Casing-748', 'ATX', 181, 322, 155, '280mm', '240mm', '240mm', 4, true, false, 'Black', 120.90, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (102, 'Lian Li', 'Casing-436', 'Mini-ITX', 179, 361, 155, '360mm', '240mm', '240mm', 4, true, true, 'White', 108.90, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (127, 'Lian Li', 'Casing-508', 'ATX', 180, 342, 179, NULL, NULL, '240mm', 4, true, false, 'White', 88.40, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (132, 'Fractal Design', 'Casing-674', 'Mini-ITX', 220, 366, 174, NULL, NULL, NULL, 2, true, true, 'Black', 224.70, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (136, 'Fractal Design', 'Casing-880', 'ATX', 168, 345, 166, '360mm', '360mm', '280mm', 1, true, true, 'White', 163.30, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (139, 'Corsair', 'Casing-566', 'ATX', 182, 329, 153, NULL, '360mm', '360mm', 1, true, false, 'Black', 116.50, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (165, 'NZXT', 'Casing-774', 'Mini-ITX', 195, 381, 151, '280mm', '240mm', '240mm', 3, false, false, 'White', 273.80, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (172, 'Corsair', 'Casing-752', 'Micro-ATX', 204, 359, 154, '280mm', '360mm', '360mm', 2, false, false, 'Silver', 210.10, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (185, 'Cooler Master', 'Casing-841', 'Mini-ITX', 210, 366, 154, '280mm', NULL, '240mm', 4, true, false, 'Silver', 287.60, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (189, 'Fractal Design', 'Casing-775', 'Mini-ITX', 211, 361, 178, '240mm', NULL, '360mm', 2, false, false, 'Black', 104.10, 'https://example.com/casing');
...
INSERT INTO public.casing VALUES (193, 'Cooler Master', 'Casing-670', 'ATX', 186, 398, 167, NULL, '280mm', NULL, 2, true, true, 'White', 255.10, 'https://example.com/casing');
INSERT INTO public.casing VALUES (194, 'Fractal Design', 'Casing-369', 'Micro-ATX', 209, 367, 167, '280mm', '240mm', '240mm', 1, false, true, 'White', 256.20, 'https://example.com/casing');
...
--
-- Data for Name: cpu; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: cpu_cooler; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.cpu_cooler VALUES (3, 'be quiet!', 'Cooler-760', 'AM4,AM5,LGA1700,LGA1200', 'AIO', 150, NULL, 165, 44, 'White', true, true, 151.40, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (9, 'NZXT', 'Cooler-253', 'AM4,AM5,LGA1700,LGA1200', 'Air', NULL, 240, 204, 51, 'Silver', false, true, 195.70, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (11, 'Corsair', 'Cooler-805', 'AM4,AM5,LGA1700,LGA1200', 'Air', 150, 240, 212, 55, 'Silver', true, false, 218.20, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (15, 'Corsair', 'Cooler-169', 'AM4,AM5,LGA1700,LGA1200', 'AIO', 160, 240, 229, 41, 'White', true, false, 100.20, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (24, 'Cooler Master', 'Cooler-100', 'AM4,AM5,LGA1700,LGA1200', 'AIO', 120, 280, 206, 53, 'Silver', true, true, 122.50, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (27, 'Corsair', 'Cooler-536', 'AM4,AM5,LGA1700,LGA1200', 'AIO', 160, NULL, 193, 58, 'White', false, true, 140.60, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (47, 'Noctua', 'Cooler-810', 'AM4,AM5,LGA1700,LGA1200', 'AIO', 160, 240, 161, 54, 'White', true, true, 223.70, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (66, 'Cooler Master', 'Cooler-649', 'AM4,AM5,LGA1700,LGA1200', 'Custom Loop', 150, 240, 197, 57, 'White', false, true, 160.50, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (82, 'Cooler Master', 'Cooler-826', 'AM4,AM5,LGA1700,LGA1200', 'Air', NULL, 280, 203, 40, 'White', true, false, 235.00, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (125, 'Corsair', 'Cooler-807', 'AM4,AM5,LGA1700,LGA1200', 'Custom Loop', 120, 280, 208, 41, 'Silver', true, true, 132.90, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (137, 'Noctua', 'Cooler-843', 'AM4,AM5,LGA1700,LGA1200', 'AIO', 150, NULL, 191, 59, 'Black', true, true, 167.20, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (143, 'NZXT', 'Cooler-655', 'AM4,AM5,LGA1700,LGA1200', 'Air', 160, 240, 175, 59, 'Black', true, false, 43.60, 'https://example.com/cooler');
INSERT INTO public.cpu_cooler VALUES (144, 'be quiet!', 'Cooler-457', 'AM4,AM5,LGA1700,LGA1200', 'Custom Loop', 120, 240, 174, 51, 'Black', true, true, 208.80, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (148, 'Cooler Master', 'Cooler-565', 'AM4,AM5,LGA1700,LGA1200', 'Air', 160, 240, 239, 50, 'Silver', false, true, 181.60, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (152, 'NZXT', 'Cooler-709', 'AM4,AM5,LGA1700,LGA1200', 'AIO', 160, 360, 229, 57, 'Black', false, false, 179.00, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (157, 'NZXT', 'Cooler-681', 'AM4,AM5,LGA1700,LGA1200', 'AIO', NULL, 240, 227, 59, 'Silver', true, false, 136.60, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (163, 'Corsair', 'Cooler-570', 'AM4,AM5,LGA1700,LGA1200', 'Custom Loop', 160, 280, 183, 57, 'Silver', true, false, 160.70, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (168, 'Noctua', 'Cooler-209', 'AM4,AM5,LGA1700,LGA1200', 'AIO', 120, NULL, 201, 42, 'Black', false, false, 121.90, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (173, 'Noctua', 'Cooler-722', 'AM4,AM5,LGA1700,LGA1200', 'Air', NULL, 240, 206, 58, 'Silver', false, false, 249.90, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (177, 'NZXT', 'Cooler-996', 'AM4,AM5,LGA1700,LGA1200', 'Custom Loop', 150, 360, 250, 52, 'Silver', false, true, 50.30, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (179, 'Cooler Master', 'Cooler-707', 'AM4,AM5,LGA1700,LGA1200', 'AIO', 120, NULL, 192, 45, 'Silver', true, true, 62.10, 'https://example.com/cooler');
...
INSERT INTO public.cpu_cooler VALUES (186, 'Cooler Master', 'Cooler-488', 'AM4,AM5,LGA1700,LGA1200', 'AIO', NULL, 360, 152, 52, 'Black', false, false, 235.50, 'https://example.com/cooler');
...
--
-- Data for Name: gpu; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.gpu VALUES (1, 'Gigabyte', 'RTX 4080 Custom Edition', 'RTX 4080', 10, 421, '8-pin', 1, 319, 109, 3.0, true, 1064.64, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (2, 'ASUS', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 16, 362, '6-pin', 2, 321, 116, 3.0, false, 1560.08, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (3, 'NVIDIA', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 10, 256, '8-pin', 1, 253, 117, 2.5, false, 1508.45, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (4, 'AMD', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 16, 296, '8-pin', 2, 265, 110, 2.0, true, 1389.52, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (5, 'AMD', 'RTX 4080 Custom Edition', 'RTX 4080', 12, 342, '6-pin', 1, 258, 105, 2.0, true, 645.82, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (6, 'NVIDIA', 'RTX 4070 Custom Edition', 'RTX 4070', 10, 275, '6-pin', 2, 287, 119, 2.0, false, 1591.78, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (7, 'NVIDIA', 'RTX 4080 Custom Edition', 'RTX 4080', 16, 160, '6-pin', 1, 250, 114, 2.0, false, 1467.15, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (8, 'NVIDIA', 'RTX 4070 Custom Edition', 'RTX 4070', 12, 293, '16-pin', 2, 243, 112, 3.0, false, 924.88, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (9, 'AMD', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 10, 347, '8-pin', 1, 239, 116, 3.0, false, 1509.70, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (10, 'NVIDIA', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 24, 178, '6-pin', 1, 261, 109, 3.0, true, 1358.41, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (11, 'ASUS', 'RTX 4060 Custom Edition', 'RTX 4060', 16, 307, '6-pin', 2, 249, 121, 2.5, true, 442.84, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (12, 'MSI', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 10, 254, '16-pin', 1, 316, 115, 2.5, true, 889.68, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (13, 'MSI', 'RX 7600 Custom Edition', 'RX 7600', 10, 449, '16-pin', 1, 294, 132, 2.0, true, 303.39, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (14, 'ASUS', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 12, 354, '8-pin', 1, 284, 110, 2.0, true, 1487.11, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (15, 'NVIDIA', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 24, 440, '8-pin', 1, 273, 122, 2.5, true, 792.70, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (16, 'AMD', 'RX 7600 Custom Edition', 'RX 7600', 8, 249, '6-pin', 1, 311, 111, 2.0, true, 502.41, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (17, 'ASUS', 'RTX 4060 Custom Edition', 'RTX 4060', 8, 434, '16-pin', 1, 283, 106, 2.5, true, 1593.72, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (18, 'Gigabyte', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 8, 237, '16-pin', 1, 329, 129, 3.0, false, 349.47, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (19, 'MSI', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 10, 193, '8-pin', 1, 263, 102, 2.0, false, 664.64, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (20, 'ASUS', 'RX 7600 Custom Edition', 'RX 7600', 8, 423, '16-pin', 1, 290, 110, 2.0, false, 1106.97, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (21, 'ASUS', 'RTX 4080 Custom Edition', 'RTX 4080', 10, 359, '16-pin', 2, 231, 111, 2.0, true, 969.62, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (22, 'MSI', 'RTX 4070 Custom Edition', 'RTX 4070', 24, 196, '16-pin', 2, 275, 124, 3.0, false, 202.90, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (23, 'ASUS', 'RTX 4080 Custom Edition', 'RTX 4080', 24, 164, '8-pin', 2, 317, 108, 3.0, false, 967.05, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (24, 'Gigabyte', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 12, 166, '16-pin', 2, 320, 132, 3.0, false, 1278.65, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (25, 'NVIDIA', 'RTX 4080 Custom Edition', 'RTX 4080', 10, 258, '8-pin', 1, 298, 125, 2.5, true, 1398.43, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (26, 'Gigabyte', 'RTX 4070 Custom Edition', 'RTX 4070', 10, 372, '8-pin', 2, 326, 114, 2.0, false, 576.54, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (27, 'Gigabyte', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 20, 301, '6-pin', 2, 279, 115, 2.5, false, 570.15, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (28, 'AMD', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 20, 347, '16-pin', 2, 268, 133, 3.0, false, 219.21, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (29, 'MSI', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 20, 325, '6-pin', 2, 314, 104, 3.0, false, 1348.08, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (30, 'MSI', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 20, 428, '8-pin', 2, 226, 116, 3.0, false, 1041.70, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (31, 'ASUS', 'RTX 4070 Custom Edition', 'RTX 4070', 24, 164, '6-pin', 1, 285, 113, 2.5, true, 836.39, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (32, 'MSI', 'RTX 4070 Custom Edition', 'RTX 4070', 20, 333, '8-pin', 1, 279, 111, 3.0, true, 498.26, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (33, 'NVIDIA', 'RTX 4080 Custom Edition', 'RTX 4080', 16, 205, '6-pin', 1, 289, 107, 2.5, true, 1221.71, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (34, 'MSI', 'RX 7600 Custom Edition', 'RX 7600', 8, 287, '16-pin', 1, 323, 138, 2.0, false, 927.64, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (35, 'ASUS', 'RTX 4080 Custom Edition', 'RTX 4080', 20, 191, '6-pin', 2, 244, 124, 2.5, true, 897.05, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (36, 'Gigabyte', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 24, 421, '6-pin', 1, 271, 122, 3.0, false, 834.30, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (37, 'Gigabyte', 'RTX 4080 Custom Edition', 'RTX 4080', 10, 322, '8-pin', 2, 312, 102, 2.5, false, 879.94, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (38, 'MSI', 'RTX 4080 Custom Edition', 'RTX 4080', 8, 409, '16-pin', 1, 250, 120, 2.0, false, 1030.67, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (39, 'Gigabyte', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 10, 296, '6-pin', 1, 252, 115, 2.5, true, 1446.32, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (40, 'ASUS', 'RTX 4060 Custom Edition', 'RTX 4060', 10, 235, '16-pin', 1, 230, 122, 2.5, false, 1253.49, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (41, 'AMD', 'RTX 4060 Custom Edition', 'RTX 4060', 20, 431, '8-pin', 1, 270, 119, 2.5, true, 512.75, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (42, 'AMD', 'RX 7600 Custom Edition', 'RX 7600', 8, 204, '6-pin', 1, 308, 104, 3.0, false, 1538.39, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (43, 'Gigabyte', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 16, 278, '16-pin', 1, 297, 117, 2.5, false, 742.40, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (44, 'Gigabyte', 'RX 7600 Custom Edition', 'RX 7600', 12, 425, '16-pin', 1, 247, 133, 2.0, true, 1402.02, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (45, 'NVIDIA', 'RTX 4080 Custom Edition', 'RTX 4080', 10, 362, '16-pin', 1, 320, 104, 2.5, true, 1451.28, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (46, 'AMD', 'RTX 4060 Custom Edition', 'RTX 4060', 12, 348, '8-pin', 2, 328, 100, 2.0, false, 471.40, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (47, 'Gigabyte', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 24, 281, '16-pin', 1, 278, 102, 3.0, true, 794.41, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (48, 'AMD', 'RTX 4060 Custom Edition', 'RTX 4060', 10, 216, '6-pin', 2, 261, 101, 3.0, false, 643.22, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (49, 'ASUS', 'RTX 4080 Custom Edition', 'RTX 4080', 24, 325, '8-pin', 2, 242, 115, 3.0, true, 416.60, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (50, 'AMD', 'RTX 4060 Custom Edition', 'RTX 4060', 24, 381, '16-pin', 1, 282, 110, 2.0, true, 1364.98, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (51, 'AMD', 'RX 7600 Custom Edition', 'RX 7600', 24, 354, '6-pin', 2, 327, 139, 3.0, false, 1355.36, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (52, 'MSI', 'RTX 4070 Custom Edition', 'RTX 4070', 20, 174, '6-pin', 1, 321, 120, 2.0, false, 976.19, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (53, 'Gigabyte', 'RTX 4080 Custom Edition', 'RTX 4080', 12, 252, '6-pin', 2, 267, 138, 2.0, false, 1507.69, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (54, 'ASUS', 'RX 7600 Custom Edition', 'RX 7600', 8, 252, '8-pin', 1, 302, 111, 2.5, false, 243.11, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (55, 'Gigabyte', 'RTX 4070 Custom Edition', 'RTX 4070', 8, 336, '16-pin', 2, 275, 137, 2.5, true, 1573.71, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (56, 'AMD', 'RTX 4070 Custom Edition', 'RTX 4070', 10, 251, '8-pin', 1, 231, 120, 2.0, false, 1083.99, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (57, 'NVIDIA', 'RTX 4060 Custom Edition', 'RTX 4060', 20, 168, '8-pin', 1, 259, 101, 3.0, true, 1214.88, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (58, 'NVIDIA', 'RTX 4080 Custom Edition', 'RTX 4080', 8, 373, '8-pin', 2, 326, 127, 3.0, false, 630.83, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (59, 'MSI', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 20, 207, '16-pin', 2, 263, 112, 2.0, false, 1123.80, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (60, 'ASUS', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 10, 367, '8-pin', 1, 284, 136, 3.0, true, 477.12, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (61, 'ASUS', 'RX 7600 Custom Edition', 'RX 7600', 10, 163, '16-pin', 2, 276, 127, 3.0, false, 1557.28, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (62, 'AMD', 'RTX 4060 Custom Edition', 'RTX 4060', 12, 356, '8-pin', 1, 230, 114, 3.0, false, 506.45, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (63, 'ASUS', 'RTX 4070 Custom Edition', 'RTX 4070', 8, 266, '16-pin', 1, 233, 105, 2.0, false, 824.52, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (64, 'AMD', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 16, 443, '16-pin', 2, 243, 127, 2.0, true, 1043.09, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (65, 'MSI', 'RTX 4060 Custom Edition', 'RTX 4060', 16, 284, '16-pin', 1, 309, 108, 2.0, false, 858.03, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (66, 'MSI', 'RX 7600 Custom Edition', 'RX 7600', 24, 337, '8-pin', 1, 266, 107, 3.0, false, 1069.03, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (67, 'AMD', 'RTX 4080 Custom Edition', 'RTX 4080', 10, 358, '8-pin', 1, 237, 137, 2.5, false, 822.05, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (68, 'AMD', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 20, 317, '16-pin', 1, 322, 102, 3.0, false, 425.52, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (69, 'NVIDIA', 'RTX 4060 Custom Edition', 'RTX 4060', 24, 220, '6-pin', 2, 278, 106, 2.5, false, 487.87, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (70, 'MSI', 'RX 7600 Custom Edition', 'RX 7600', 20, 370, '16-pin', 2, 302, 117, 2.5, true, 757.74, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (71, 'MSI', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 10, 395, '16-pin', 1, 262, 122, 2.5, false, 365.29, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (72, 'Gigabyte', 'RTX 4070 Custom Edition', 'RTX 4070', 20, 242, '8-pin', 2, 328, 102, 2.5, true, 1312.45, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (73, 'AMD', 'RTX 4060 Custom Edition', 'RTX 4060', 16, 305, '6-pin', 1, 230, 132, 2.0, false, 1013.41, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (74, 'NVIDIA', 'RX 7600 Custom Edition', 'RX 7600', 12, 223, '16-pin', 1, 318, 132, 3.0, true, 1440.06, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (75, 'NVIDIA', 'RX 7600 Custom Edition', 'RX 7600', 12, 447, '8-pin', 1, 321, 128, 2.0, true, 1118.82, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (76, 'MSI', 'RX 7600 Custom Edition', 'RX 7600', 8, 382, '8-pin', 1, 246, 107, 3.0, false, 815.74, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (77, 'AMD', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 12, 312, '8-pin', 1, 308, 131, 2.0, true, 519.87, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (78, 'MSI', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 12, 382, '6-pin', 2, 288, 124, 2.5, true, 453.73, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (79, 'Gigabyte', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 12, 365, '8-pin', 2, 248, 111, 2.0, false, 949.56, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (80, 'MSI', 'RTX 4080 Custom Edition', 'RTX 4080', 8, 390, '16-pin', 2, 273, 112, 3.0, true, 1434.30, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (81, 'NVIDIA', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 24, 191, '8-pin', 1, 240, 109, 2.0, true, 430.24, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (82, 'NVIDIA', 'RTX 4060 Custom Edition', 'RTX 4060', 24, 315, '8-pin', 1, 326, 129, 2.0, true, 451.44, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (83, 'NVIDIA', 'RTX 4060 Custom Edition', 'RTX 4060', 10, 232, '8-pin', 1, 231, 102, 3.0, true, 488.18, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (84, 'ASUS', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 10, 251, '8-pin', 2, 264, 140, 2.0, true, 893.05, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (85, 'Gigabyte', 'RTX 4060 Custom Edition', 'RTX 4060', 12, 193, '8-pin', 2, 247, 132, 2.5, false, 1106.42, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (86, 'ASUS', 'RTX 4060 Custom Edition', 'RTX 4060', 20, 240, '16-pin', 2, 326, 121, 3.0, true, 1255.36, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (87, 'Gigabyte', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 10, 425, '16-pin', 1, 322, 128, 2.5, false, 624.90, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (88, 'MSI', 'RTX 4070 Custom Edition', 'RTX 4070', 16, 355, '8-pin', 2, 312, 123, 3.0, true, 1378.76, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (89, 'AMD', 'RX 7600 Custom Edition', 'RX 7600', 12, 241, '8-pin', 1, 318, 100, 2.0, true, 433.63, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (90, 'MSI', 'RX 7600 Custom Edition', 'RX 7600', 16, 206, '8-pin', 2, 244, 140, 2.5, false, 624.38, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (91, 'MSI', 'RTX 4070 Custom Edition', 'RTX 4070', 24, 420, '16-pin', 1, 287, 138, 2.0, false, 790.01, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (92, 'MSI', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 24, 370, '8-pin', 2, 230, 101, 3.0, false, 980.92, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (93, 'MSI', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 10, 264, '6-pin', 1, 295, 135, 2.5, true, 660.17, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (94, 'MSI', 'RTX 4070 Custom Edition', 'RTX 4070', 12, 446, '6-pin', 2, 275, 106, 3.0, false, 1346.53, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (95, 'Gigabyte', 'RTX 4060 Custom Edition', 'RTX 4060', 10, 369, '6-pin', 2, 274, 109, 2.0, true, 849.47, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (96, 'AMD', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 12, 340, '16-pin', 1, 230, 131, 2.5, true, 947.27, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (97, 'AMD', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 24, 183, '8-pin', 2, 296, 116, 2.0, true, 382.72, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (98, 'Gigabyte', 'RX 7600 Custom Edition', 'RX 7600', 24, 197, '8-pin', 1, 236, 130, 2.5, true, 687.48, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (99, 'Gigabyte', 'RTX 4070 Custom Edition', 'RTX 4070', 10, 388, '8-pin', 2, 283, 140, 2.0, false, 1266.92, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (100, 'AMD', 'RTX 4080 Custom Edition', 'RTX 4080', 8, 442, '8-pin', 2, 236, 114, 3.0, false, 817.60, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (101, 'AMD', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 12, 180, '6-pin', 1, 306, 124, 3.0, false, 691.31, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (102, 'NVIDIA', 'RX 7600 Custom Edition', 'RX 7600', 24, 429, '16-pin', 2, 311, 130, 2.5, true, 817.10, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (103, 'Gigabyte', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 16, 370, '6-pin', 2, 243, 127, 2.0, true, 1495.87, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (104, 'MSI', 'RTX 4080 Custom Edition', 'RTX 4080', 12, 214, '6-pin', 2, 267, 116, 2.5, false, 510.12, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (105, 'NVIDIA', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 12, 331, '8-pin', 1, 249, 133, 3.0, false, 1589.07, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (106, 'NVIDIA', 'RTX 4080 Custom Edition', 'RTX 4080', 16, 202, '8-pin', 1, 299, 107, 2.0, false, 1349.50, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (107, 'AMD', 'RTX 4060 Custom Edition', 'RTX 4060', 8, 174, '6-pin', 1, 330, 101, 2.5, false, 352.90, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (108, 'Gigabyte', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 10, 425, '16-pin', 1, 302, 137, 3.0, true, 1314.31, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (109, 'AMD', 'RTX 4060 Custom Edition', 'RTX 4060', 20, 358, '16-pin', 1, 305, 108, 3.0, false, 848.53, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (110, 'NVIDIA', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 10, 249, '6-pin', 2, 306, 106, 2.5, false, 967.00, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (111, 'AMD', 'RTX 4080 Custom Edition', 'RTX 4080', 20, 189, '6-pin', 2, 249, 101, 3.0, false, 763.02, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (112, 'AMD', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 20, 295, '6-pin', 2, 301, 128, 2.5, true, 798.83, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (113, 'ASUS', 'RX 7600 Custom Edition', 'RX 7600', 8, 201, '16-pin', 1, 230, 108, 2.5, true, 1384.12, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (114, 'MSI', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 12, 373, '8-pin', 2, 319, 127, 2.0, false, 599.99, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (115, 'ASUS', 'RX 7600 Custom Edition', 'RX 7600', 10, 299, '16-pin', 1, 287, 103, 3.0, true, 740.36, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (116, 'NVIDIA', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 20, 257, '16-pin', 1, 258, 119, 3.0, true, 609.49, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (117, 'ASUS', 'RTX 4080 Custom Edition', 'RTX 4080', 20, 283, '6-pin', 1, 285, 120, 2.0, false, 1318.37, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (118, 'MSI', 'RTX 4080 Custom Edition', 'RTX 4080', 10, 301, '8-pin', 1, 287, 119, 2.0, true, 352.91, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (119, 'Gigabyte', 'RTX 4080 Custom Edition', 'RTX 4080', 12, 313, '6-pin', 2, 319, 102, 2.0, false, 1194.60, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (120, 'NVIDIA', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 12, 282, '8-pin', 1, 312, 106, 3.0, true, 973.07, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (121, 'MSI', 'RTX 4080 Custom Edition', 'RTX 4080', 10, 254, '6-pin', 2, 324, 125, 3.0, false, 1223.63, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (122, 'ASUS', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 24, 385, '8-pin', 2, 264, 125, 3.0, false, 1548.06, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (123, 'NVIDIA', 'RTX 4080 Custom Edition', 'RTX 4080', 24, 430, '6-pin', 1, 276, 140, 2.0, true, 791.29, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (124, 'MSI', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 16, 326, '16-pin', 1, 228, 134, 2.5, true, 899.77, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (125, 'ASUS', 'RX 7600 Custom Edition', 'RX 7600', 16, 415, '6-pin', 1, 287, 120, 3.0, false, 1387.17, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (126, 'ASUS', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 20, 371, '16-pin', 1, 258, 119, 2.5, false, 824.43, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (127, 'AMD', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 10, 269, '8-pin', 1, 300, 110, 2.0, false, 1311.15, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (128, 'MSI', 'RTX 4080 Custom Edition', 'RTX 4080', 10, 398, '16-pin', 2, 287, 113, 3.0, true, 766.40, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (129, 'MSI', 'RTX 4080 Custom Edition', 'RTX 4080', 8, 161, '8-pin', 2, 321, 102, 3.0, false, 364.33, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (130, 'MSI', 'RTX 4070 Custom Edition', 'RTX 4070', 10, 289, '6-pin', 2, 319, 106, 2.5, false, 1498.94, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (131, 'ASUS', 'RTX 4060 Custom Edition', 'RTX 4060', 16, 252, '8-pin', 2, 313, 130, 2.0, false, 468.96, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (132, 'NVIDIA', 'RTX 4080 Custom Edition', 'RTX 4080', 10, 242, '6-pin', 1, 301, 105, 3.0, false, 748.62, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (133, 'MSI', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 24, 408, '16-pin', 2, 292, 125, 2.0, true, 789.83, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (134, 'MSI', 'RTX 4060 Custom Edition', 'RTX 4060', 8, 229, '8-pin', 1, 294, 138, 2.5, false, 965.94, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (135, 'MSI', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 24, 313, '8-pin', 1, 323, 129, 2.5, true, 828.99, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (136, 'MSI', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 12, 431, '6-pin', 1, 323, 121, 2.5, false, 336.40, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (137, 'Gigabyte', 'RTX 4060 Custom Edition', 'RTX 4060', 16, 271, '16-pin', 1, 225, 130, 3.0, true, 1395.38, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (138, 'ASUS', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 24, 292, '8-pin', 2, 264, 100, 3.0, true, 651.87, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (139, 'Gigabyte', 'RTX 4060 Custom Edition', 'RTX 4060', 12, 418, '8-pin', 2, 321, 120, 2.5, true, 439.57, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (140, 'Gigabyte', 'RX 7600 Custom Edition', 'RX 7600', 10, 447, '8-pin', 1, 287, 126, 2.0, false, 1055.57, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (141, 'ASUS', 'RTX 4080 Custom Edition', 'RTX 4080', 8, 398, '8-pin', 2, 329, 131, 2.0, true, 268.26, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (142, 'Gigabyte', 'RX 7600 Custom Edition', 'RX 7600', 24, 344, '8-pin', 2, 243, 122, 3.0, false, 1490.59, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (143, 'AMD', 'RTX 4080 Custom Edition', 'RTX 4080', 8, 364, '8-pin', 2, 310, 127, 2.5, false, 850.67, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (144, 'Gigabyte', 'RX 7600 Custom Edition', 'RX 7600', 20, 370, '6-pin', 2, 308, 122, 2.5, true, 1571.93, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (145, 'AMD', 'RTX 4060 Custom Edition', 'RTX 4060', 10, 399, '16-pin', 1, 292, 129, 3.0, true, 237.97, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (146, 'AMD', 'RX 7600 Custom Edition', 'RX 7600', 12, 315, '16-pin', 1, 280, 114, 2.5, false, 875.11, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (147, 'Gigabyte', 'RTX 4080 Custom Edition', 'RTX 4080', 12, 353, '16-pin', 1, 251, 135, 2.0, false, 1298.81, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (148, 'MSI', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 12, 338, '16-pin', 1, 243, 130, 3.0, true, 601.65, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (149, 'NVIDIA', 'RX 7600 Custom Edition', 'RX 7600', 20, 277, '6-pin', 1, 315, 102, 3.0, false, 334.99, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (150, 'ASUS', 'RTX 4070 Custom Edition', 'RTX 4070', 12, 208, '16-pin', 2, 263, 123, 3.0, false, 920.09, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (151, 'Gigabyte', 'RTX 4070 Custom Edition', 'RTX 4070', 16, 239, '6-pin', 2, 324, 124, 2.5, true, 1146.67, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (152, 'ASUS', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 12, 434, '8-pin', 1, 265, 131, 2.0, false, 1381.68, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (153, 'ASUS', 'RX 7600 Custom Edition', 'RX 7600', 24, 423, '6-pin', 2, 328, 110, 2.5, false, 781.42, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (154, 'MSI', 'RTX 4060 Custom Edition', 'RTX 4060', 10, 290, '6-pin', 2, 241, 138, 2.5, false, 1062.13, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (155, 'NVIDIA', 'RTX 4080 Custom Edition', 'RTX 4080', 12, 268, '16-pin', 2, 255, 130, 3.0, false, 208.86, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (156, 'ASUS', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 20, 160, '16-pin', 1, 321, 107, 2.5, true, 870.67, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (157, 'Gigabyte', 'RX 7600 Custom Edition', 'RX 7600', 20, 402, '16-pin', 1, 276, 139, 3.0, false, 807.10, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (158, 'Gigabyte', 'RTX 4070 Custom Edition', 'RTX 4070', 12, 334, '16-pin', 1, 270, 116, 2.0, true, 446.09, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (159, 'NVIDIA', 'RTX 4060 Custom Edition', 'RTX 4060', 10, 219, '8-pin', 1, 289, 139, 2.0, false, 1145.57, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (160, 'ASUS', 'RTX 4070 Custom Edition', 'RTX 4070', 12, 203, '8-pin', 1, 305, 126, 2.5, false, 658.85, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (161, 'NVIDIA', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 24, 395, '16-pin', 2, 257, 101, 2.5, false, 1289.50, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (162, 'MSI', 'RX 7600 Custom Edition', 'RX 7600', 12, 176, '6-pin', 1, 260, 127, 3.0, false, 846.55, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (163, 'NVIDIA', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 16, 307, '8-pin', 2, 309, 130, 2.0, true, 1596.91, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (164, 'MSI', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 16, 409, '6-pin', 1, 319, 135, 2.5, false, 1503.85, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (165, 'NVIDIA', 'RTX 4070 Custom Edition', 'RTX 4070', 12, 183, '6-pin', 2, 318, 108, 2.5, false, 613.75, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (166, 'ASUS', 'RTX 4070 Custom Edition', 'RTX 4070', 20, 320, '16-pin', 1, 263, 135, 3.0, false, 972.84, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (167, 'AMD', 'RTX 4070 Custom Edition', 'RTX 4070', 24, 223, '6-pin', 1, 244, 115, 2.0, false, 535.78, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (168, 'MSI', 'RTX 4080 Custom Edition', 'RTX 4080', 8, 274, '6-pin', 1, 252, 118, 3.0, true, 1177.01, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (169, 'NVIDIA', 'RX 7600 Custom Edition', 'RX 7600', 8, 318, '6-pin', 2, 283, 131, 3.0, false, 1438.69, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (170, 'Gigabyte', 'RX 7600 Custom Edition', 'RX 7600', 20, 277, '16-pin', 1, 300, 137, 2.5, false, 280.85, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (171, 'NVIDIA', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 10, 201, '6-pin', 1, 242, 134, 2.0, false, 516.42, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (172, 'MSI', 'RTX 4080 Custom Edition', 'RTX 4080', 24, 215, '8-pin', 1, 329, 119, 2.0, false, 1079.08, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (173, 'Gigabyte', 'RTX 4060 Custom Edition', 'RTX 4060', 10, 394, '16-pin', 1, 242, 127, 3.0, false, 1102.97, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (174, 'AMD', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 24, 445, '8-pin', 2, 257, 119, 2.0, false, 815.23, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (175, 'NVIDIA', 'RTX 4070 Custom Edition', 'RTX 4070', 12, 421, '16-pin', 2, 252, 138, 2.5, false, 1201.43, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (176, 'NVIDIA', 'RTX 4070 Custom Edition', 'RTX 4070', 12, 293, '6-pin', 2, 244, 117, 2.0, true, 869.32, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (177, 'MSI', 'RTX 4070 Custom Edition', 'RTX 4070', 12, 186, '6-pin', 2, 283, 122, 3.0, false, 762.58, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (178, 'NVIDIA', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 16, 194, '6-pin', 1, 254, 117, 3.0, false, 795.98, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (179, 'ASUS', 'RTX 4080 Custom Edition', 'RTX 4080', 12, 409, '6-pin', 2, 230, 121, 2.5, true, 726.25, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (180, 'Gigabyte', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 10, 280, '16-pin', 1, 316, 120, 3.0, true, 811.10, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (181, 'MSI', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 20, 227, '16-pin', 2, 296, 124, 2.5, true, 828.38, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (182, 'ASUS', 'RX 7600 Custom Edition', 'RX 7600', 24, 250, '8-pin', 1, 239, 113, 2.0, false, 756.17, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (183, 'Gigabyte', 'RTX 4060 Custom Edition', 'RTX 4060', 20, 195, '8-pin', 2, 240, 139, 2.5, false, 385.54, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (184, 'MSI', 'RTX 4070 Custom Edition', 'RTX 4070', 8, 415, '16-pin', 1, 295, 138, 3.0, true, 1039.09, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (185, 'NVIDIA', 'RX 7600 Custom Edition', 'RX 7600', 12, 178, '6-pin', 2, 248, 132, 3.0, true, 1177.14, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (186, 'ASUS', 'RX 7600 Custom Edition', 'RX 7600', 10, 286, '8-pin', 1, 325, 136, 2.0, true, 1152.87, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (187, 'AMD', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 24, 392, '6-pin', 1, 266, 100, 2.5, true, 772.02, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (188, 'AMD', 'RTX 4060 Custom Edition', 'RTX 4060', 8, 339, '16-pin', 1, 233, 103, 2.0, true, 1410.85, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (189, 'AMD', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 10, 347, '16-pin', 2, 320, 123, 2.0, true, 908.46, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (190, 'ASUS', 'RX 7600 Custom Edition', 'RX 7600', 24, 170, '16-pin', 1, 270, 105, 2.0, false, 367.33, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (191, 'NVIDIA', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 24, 425, '6-pin', 1, 272, 131, 3.0, true, 476.84, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (192, 'AMD', 'RX 7900 XTX Custom Edition', 'RX 7900 XTX', 8, 211, '6-pin', 2, 283, 130, 2.5, false, 448.22, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (193, 'NVIDIA', 'RTX 4080 Custom Edition', 'RTX 4080', 12, 312, '6-pin', 2, 289, 111, 2.5, false, 593.89, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (194, 'MSI', 'RX 7600 Custom Edition', 'RX 7600', 24, 389, '16-pin', 1, 251, 124, 3.0, true, 304.58, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (195, 'AMD', 'RX 7600 Custom Edition', 'RX 7600', 20, 234, '16-pin', 2, 235, 130, 2.5, true, 577.75, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (196, 'MSI', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 20, 392, '16-pin', 2, 328, 139, 3.0, true, 1269.50, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (197, 'Gigabyte', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 10, 309, '6-pin', 2, 293, 120, 3.0, true, 1088.49, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (198, 'Gigabyte', 'RX 7600 Custom Edition', 'RX 7600', 20, 402, '6-pin', 2, 306, 132, 3.0, false, 1297.00, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (199, 'AMD', 'RX 7700 XT Custom Edition', 'RX 7700 XT', 24, 169, '6-pin', 1, 326, 125, 2.5, true, 233.36, 'https://example.com/gpu');
INSERT INTO public.gpu VALUES (200, 'Gigabyte', 'RTX 4080 Custom Edition', 'RTX 4080', 20, 299, '6-pin', 1, 261, 124, 2.0, false, 1071.88, 'https://example.com/gpu');


--
-- Data for Name: motherboard; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.motherboard VALUES (5, 'Gigabyte', 'X670E-243 Pro', 'X670E', 'AM5', 'ATX', 'DDR5', 4, 3600, 1, 3, 2, 'PCIe 5.0', 6, '2.5GbE', NULL, '5.1', 2, 2, 0, 0, 140, NULL, 230.40, 'https://example.com/gigabyte/x670e-243-pro');
...
INSERT INTO public.motherboard VALUES (7, 'ASUS', 'H670-662 Pro', 'H670', 'LGA1700', 'Mini-ITX', 'DDR5', 4, 4800, 1, 1, 2, 'PCIe 5.0', 8, '2.5GbE', NULL, '5.0', 4, 4, 0, 0, 120, NULL, 399.20, 'https://example.com/asus/h670-662-pro');
...
INSERT INTO public.motherboard VALUES (11, 'ASUS', 'B650E-513 Pro', 'B650E', 'AM5', 'Mini-ITX', 'DDR5', 4, 3600, 1, 2, 1, 'PCIe 5.0', 4, '2.5GbE', 'Wi-Fi 5', '4.2', 4, 4, 1, NULL, 120, 'BIOS Flashback', 114.80, 'https://example.com/asus/b650e-513-pro');
...
INSERT INTO public.motherboard VALUES (17, 'MSI', 'B460-370 Pro', 'B460', 'LGA1200', 'Mini-ITX', 'DDR4', 4, 6000, 1, 1, 1, 'PCIe 4.0', 8, '1GbE', NULL, '5.1', 6, 2, 0, NULL, 140, 'Q-Flash', 344.10, 'https://example.com/msi/b460-370-pro');
...
INSERT INTO public.motherboard VALUES (37, 'MSI', 'Z790-628 Pro', 'Z790', 'LGA1700', 'ATX', 'DDR5', 4, 3600, 1, 3, 4, 'PCIe 5.0', 4, '1GbE', NULL, '5.2', 6, 2, 1, NULL, 160, 'Debug LED', 329.00, 'https://example.com/msi/z790-628-pro');
...
INSERT INTO public.motherboard VALUES (52, 'ASRock', 'Z490-961 Pro', 'Z490', 'LGA1200', 'Mini-ITX', 'DDR4', 4, 3600, 1, 1, 4, 'PCIe 4.0', 6, '1GbE', 'Wi-Fi 6', '5.2', 2, 2, 2, 0, 120, 'RGB Header', 215.50, 'https://example.com/asrock/z490-961-pro');
...
INSERT INTO public.motherboard VALUES (81, 'Biostar', 'H410-302 Pro', 'H410', 'LGA1200', 'Mini-ITX', 'DDR4', 4, 5200, 1, 3, 1, 'PCIe 5.0', 6, '2.5GbE', 'Wi-Fi 6E', '4.2', 6, 4, 2, 0, 140, 'RGB Header', 300.90, 'https://example.com/biostar/h410-302-pro');
...
INSERT INTO public.motherboard VALUES (92, 'Biostar', 'Z590-902 Pro', 'Z590', 'LGA1200', 'Micro-ATX', 'DDR4', 4, 3200, 1, 3, 1, 'PCIe 4.0', 6, '2.5GbE', 'Wi-Fi 5', '5.2', 2, 6, 0, NULL, 120, 'BIOS Flashback', 140.00, 'https://example.com/biostar/z590-902-pro');
INSERT INTO public.motherboard VALUES (93, 'ASUS', 'B660-805 Pro', 'B660', 'LGA1700', 'Mini-ITX', 'DDR5', 4, 4000, 1, 3, 3, 'PCIe 4.0', 6, '2.5GbE', 'Wi-Fi 6', '4.2', 4, 6, 0, NULL, 120, 'Q-Flash', 254.40, 'https://example.com/asus/b660-805-pro');
...
INSERT INTO public.motherboard VALUES (101, 'MSI', 'H670-582 Pro', 'H670', 'LGA1700', 'Micro-ATX', 'DDR5', 4, 3200, 1, 1, 3, 'PCIe 4.0', 6, '2.5GbE', 'Wi-Fi 6', '4.2', 2, 6, 2, 1, 120, 'BIOS Flashback', 313.00, 'https://example.com/msi/h670-582-pro');
...
INSERT INTO public.motherboard VALUES (103, 'MSI', 'X570-753 Pro', 'X570', 'AM4', 'Mini-ITX', 'DDR4', 4, 4800, 1, 2, 4, 'PCIe 5.0', 6, '1GbE', 'Wi-Fi 6E', '5.0', 2, 4, 1, 2, 120, 'Debug LED', 93.60, 'https://example.com/msi/x570-753-pro');
...
INSERT INTO public.motherboard VALUES (115, 'Biostar', 'B650E-658 Pro', 'B650E', 'AM5', 'ATX', 'DDR5', 4, 3200, 1, 2, 3, 'PCIe 5.0', 4, '2.5GbE', 'Wi-Fi 6E', '4.2', 2, 6, 1, 2, 120, 'Q-Flash', 341.20, 'https://example.com/biostar/b650e-658-pro');
...
INSERT INTO public.motherboard VALUES (131, 'ASRock', 'H670-247 Pro', 'H670', 'LGA1700', 'Micro-ATX', 'DDR5', 4, 3600, 1, 3, 2, 'PCIe 4.0', 6, '2.5GbE', NULL, '4.2', 4, 6, 1, 2, 120, 'Debug LED', 308.00, 'https://example.com/asrock/h670-247-pro');
...
INSERT INTO public.motherboard VALUES (136, 'ASUS', 'B650E-843 Pro', 'B650E', 'AM5', 'ATX', 'DDR5', 4, 4000, 1, 3, 1, 'PCIe 5.0', 8, '1GbE', 'Wi-Fi 6', '5.0', 4, 2, 2, 0, 140, 'Q-Flash', 355.80, 'https://example.com/asus/b650e-843-pro');
...
INSERT INTO public.motherboard VALUES (145, 'Gigabyte', 'A520-995 Pro', 'A520', 'AM4', 'ATX', 'DDR4', 4, 4800, 1, 2, 1, 'PCIe 4.0', 6, '2.5GbE', 'Wi-Fi 5', NULL, 4, 6, 0, NULL, 160, 'BIOS Flashback', 296.80, 'https://example.com/gigabyte/a520-995-pro');
...
--
-- Data for Name: psu; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.psu VALUES (14, 'Seasonic', 'PSU-1192W', 'ATX', 1200, 180, 1, 2, 0, '80+ Bronze', true, 237.40, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (20, 'Thermaltake', 'PSU-691W', 'SFX', 650, 180, 2, 3, 0, '80+ Gold', true, 108.80, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (23, 'Thermaltake', 'PSU-524W', 'ATX', 750, 180, 2, 2, 0, '80+ Silver', false, 97.50, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (27, 'Seasonic', 'PSU-622W', 'SFX', 550, 160, 1, 4, 0, '80+ Silver', true, 128.70, 'https://example.com/psu');
INSERT INTO public.psu VALUES (28, 'Cooler Master', 'PSU-835W', 'SFX', 550, 140, 2, 1, 2, '80+ Silver', true, 222.30, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (41, 'Cooler Master', 'PSU-704W', 'ATX', 1200, 180, 1, 4, 1, '80+ Silver', false, 161.80, 'https://example.com/psu');
INSERT INTO public.psu VALUES (42, 'Thermaltake', 'PSU-1156W', 'SFX', 850, 180, 1, 2, 1, '80+ Bronze', true, 150.35, 'https://example.com/psu');
INSERT INTO public.psu VALUES (43, 'Corsair', 'PSU-1068W', 'ATX', 650, 160, 2, 2, 2, '80+ Platinum', false, 67.40, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (61, 'Corsair', 'PSU-978W', 'SFX', 550, 180, 1, 3, 1, '80+ Platinum', false, 283.10, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (66, 'EVGA', 'PSU-794W', 'SFX', 1200, 160, 1, 1, 0, '80+ Platinum', false, 219.50, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (78, 'Thermaltake', 'PSU-841W', 'ATX', 650, 180, 2, 3, 1, '80+ Silver', true, 215.20, 'https://example.com/psu');
INSERT INTO public.psu VALUES (79, 'Thermaltake', 'PSU-756W', 'ATX', 1200, 140, 1, 4, 2, '80+ Gold', true, 134.15, 'https://example.com/psu');
INSERT INTO public.psu VALUES (80, 'Seasonic', 'PSU-683W', 'ATX', 650, 140, 2, 4, 0, '80+ Silver', true, 73.50, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (83, 'Corsair', 'PSU-867W', 'ATX', 1000, 180, 2, 3, 0, '80+ Platinum', true, 278.00, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (87, 'Cooler Master', 'PSU-634W', 'ATX', 650, 140, 1, 4, 2, '80+ Bronze', false, 113.70, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (135, 'Seasonic', 'PSU-768W', 'ATX', 550, 180, 1, 3, 0, '80+ Silver', false, 146.80, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (151, 'Seasonic', 'PSU-1128W', 'SFX', 750, 160, 1, 2, 0, '80+ Silver', false, 54.20, 'https://example.com/psu');
INSERT INTO public.psu VALUES (152, 'Thermaltake', 'PSU-561W', 'ATX', 550, 180, 2, 3, 2, '80+ Platinum', false, 62.46, 'https://example.com/psu');
INSERT INTO public.psu VALUES (153, 'Seasonic', 'PSU-772W', 'SFX', 1000, 140, 2, 4, 1, '80+ Bronze', false, 61.10, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (157, 'EVGA', 'PSU-1047W', 'ATX', 550, 180, 2, 4, 0, '80+ Platinum', false, 140.00, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (166, 'Corsair', 'PSU-938W', 'SFX', 1000, 160, 1, 2, 1, '80+ Platinum', false, 227.70, 'https://example.com/psu');
INSERT INTO public.psu VALUES (167, 'Thermaltake', 'PSU-508W', 'SFX', 1200, 180, 2, 1, 1, '80+ Silver', true, 140.91, 'https://example.com/psu');
INSERT INTO public.psu VALUES (168, 'Cooler Master', 'PSU-804W', 'SFX', 850, 160, 2, 3, 1, '80+ Bronze', true, 106.60, 'https://example.com/psu');
INSERT INTO public.psu VALUES (169, 'Cooler Master', 'PSU-777W', 'SFX', 550, 140, 1, 3, 1, '80+ Bronze', true, 54.57, 'https://example.com/psu');
INSERT INTO public.psu VALUES (170, 'Corsair', 'PSU-1095W', 'SFX', 1000, 160, 2, 3, 2, '80+ Platinum', false, 79.40, 'https://example.com/psu');
INSERT INTO public.psu VALUES (171, 'Cooler Master', 'PSU-725W', 'SFX', 550, 180, 2, 1, 0, '80+ Gold', false, 233.12, 'https://example.com/psu');
INSERT INTO public.psu VALUES (172, 'Seasonic', 'PSU-1044W', 'ATX', 550, 160, 1, 3, 2, '80+ Platinum', false, 257.80, 'https://example.com/psu');
INSERT INTO public.psu VALUES (173, 'Corsair', 'PSU-927W', 'ATX', 650, 160, 1, 1, 2, '80+ Bronze', false, 158.55, 'https://example.com/psu');
INSERT INTO public.psu VALUES (174, 'EVGA', 'PSU-1003W', 'ATX', 1200, 140, 1, 1, 1, '80+ Platinum', true, 278.00, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (178, 'EVGA', 'PSU-1074W', 'SFX', 1000, 140, 1, 4, 1, '80+ Bronze', false, 131.80, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (185, 'Seasonic', 'PSU-1001W', 'ATX', 650, 180, 2, 3, 1, '80+ Silver', false, 174.60, 'https://example.com/psu');
...
INSERT INTO public.psu VALUES (192, 'Cooler Master', 'PSU-683W', 'SFX', 650, 160, 1, 4, 0, '80+ Bronze', true, 242.40, 'https://example.com/psu');
...
--
-- Data for Name: ram; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.ram VALUES (14, 'TeamGroup', 'Model-6698', 'DDR4', '8GB', 3200, 'CL16', false, 135.70, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (26, 'Crucial', 'Model-6022', 'DDR5', '32GB', 3000, 'CL15', false, 281.40, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (30, 'Corsair', 'Model-9275', 'DDR4', '8GB', 4800, 'CL19', false, 238.20, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (43, 'Crucial', 'Model-9820', 'DDR5', '16GB', 5200, 'CL16', false, 282.40, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (59, 'Crucial', 'Model-2335', 'DDR4', '8GB', 3000, 'CL16', true, 104.10, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (91, 'Crucial', 'Model-4581', 'DDR5', '64GB', 3200, 'CL15', false, 111.20, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (101, 'G.Skill', 'Model-2233', 'DDR5', '32GB', 3200, 'CL15', true, 69.60, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (106, 'Crucial', 'Model-9582', 'DDR5', '32GB', 4000, 'CL15', true, 283.70, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (113, 'G.Skill', 'Model-7618', 'DDR5', '64GB', 6000, 'CL20', false, 50.20, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (125, 'Crucial', 'Model-6021', 'DDR5', '16GB', 6000, 'CL16', true, 160.30, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (133, 'TeamGroup', 'Model-4894', 'DDR5', '64GB', 5200, 'CL20', false, 293.80, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (142, 'Crucial', 'Model-6699', 'DDR4', '64GB', 4000, 'CL16', true, 261.80, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (150, 'Corsair', 'Model-7207', 'DDR4', '16GB', 3000, 'CL18', false, 98.10, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (172, 'Kingston', 'Model-9524', 'DDR4', '8GB', 5200, 'CL20', false, 84.30, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (179, 'G.Skill', 'Model-4874', 'DDR4', '16GB', 4800, 'CL17', false, 186.70, 'https://example.com/ram');
INSERT INTO public.ram VALUES (180, 'Crucial', 'Model-2018', 'DDR4', '32GB', 5200, 'CL14', false, 31.89, 'https://example.com/ram');
INSERT INTO public.ram VALUES (181, 'TeamGroup', 'Model-5491', 'DDR4', '64GB', 4000, 'CL14', false, 210.00, 'https://example.com/ram');
...
INSERT INTO public.ram VALUES (198, 'Kingston', 'Model-5222', 'DDR4', '16GB', 3200, 'CL15', false, 155.70, 'https://example.com/ram');
...
--
-- Data for Name: ssd; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.ssd VALUES (1, 'Samsung', 'SSD-495', '1TB', 'U.2', 'PCIe 5.0', 3567, 6594, true, 245.42, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (2, 'Samsung', 'SSD-754', '2TB', 'M.2', 'PCIe 5.0', 1107, 5827, true, 45.30, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (3, 'Crucial', 'SSD-967', '1TB', '2.5"', 'PCIe 5.0', 1486, 5147, false, 316.82, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (4, 'Sabrent', 'SSD-989', '500GB', 'U.2', 'PCIe 5.0', 3711, 1743, true, 240.92, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (5, 'ADATA', 'SSD-167', '1TB', '2.5"', 'PCIe 3.0', 1569, 5412, true, 65.43, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (6, 'Samsung', 'SSD-156', '250GB', 'U.2', 'PCIe 4.0', 1435, 5303, false, 123.55, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (7, 'Crucial', 'SSD-822', '1TB', 'U.2', 'PCIe 5.0', 2378, 4127, false, 148.26, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (8, 'ADATA', 'SSD-893', '2TB', 'M.2', 'PCIe 5.0', 2730, 2378, true, 246.69, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (9, 'ADATA', 'SSD-220', '1TB', '2.5"', 'PCIe 5.0', 1176, 6590, false, 124.08, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (10, 'Samsung', 'SSD-336', '2TB', '2.5"', 'PCIe 5.0', 3171, 5117, false, 43.60, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (11, 'Samsung', 'SSD-164', '2TB', '2.5"', 'PCIe 3.0', 1813, 2065, false, 136.81, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (12, 'ADATA', 'SSD-632', '2TB', 'M.2', 'PCIe 3.0', 5627, 3461, false, 232.53, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (13, 'ADATA', 'SSD-533', '500GB', 'M.2', 'PCIe 3.0', 1719, 5906, false, 40.27, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (14, 'Western Digital', 'SSD-385', '2TB', 'M.2', 'PCIe 3.0', 3914, 1744, false, 218.68, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (15, 'ADATA', 'SSD-841', '500GB', '2.5"', 'PCIe 4.0', 6242, 3552, true, 227.08, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (16, 'Samsung', 'SSD-160', '250GB', '2.5"', 'PCIe 5.0', 6294, 2227, true, 249.04, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (17, 'Western Digital', 'SSD-104', '1TB', 'M.2', 'PCIe 5.0', 3350, 878, false, 59.06, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (18, 'ADATA', 'SSD-828', '500GB', '2.5"', 'PCIe 5.0', 2676, 6491, true, 303.33, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (19, 'ADATA', 'SSD-460', '250GB', 'U.2', 'PCIe 4.0', 3296, 6511, false, 108.44, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (20, 'Crucial', 'SSD-231', '2TB', '2.5"', 'PCIe 5.0', 6084, 4813, false, 317.97, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (21, 'Crucial', 'SSD-927', '2TB', 'M.2', 'PCIe 5.0', 4535, 4832, false, 235.78, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (22, 'Western Digital', 'SSD-954', '250GB', 'M.2', 'PCIe 5.0', 7102, 5648, true, 125.85, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (23, 'Western Digital', 'SSD-376', '2TB', 'M.2', 'PCIe 3.0', 6938, 4723, true, 215.87, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (24, 'Sabrent', 'SSD-778', '2TB', '2.5"', 'PCIe 3.0', 1455, 6510, true, 64.65, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (25, 'Samsung', 'SSD-305', '250GB', 'M.2', 'PCIe 5.0', 4342, 1502, true, 277.64, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (26, 'Western Digital', 'SSD-980', '500GB', 'U.2', 'PCIe 3.0', 7376, 5809, false, 77.00, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (27, 'Western Digital', 'SSD-868', '1TB', '2.5"', 'PCIe 3.0', 6449, 2759, false, 335.33, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (28, 'Crucial', 'SSD-276', '1TB', 'U.2', 'PCIe 5.0', 3924, 5446, false, 188.98, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (29, 'Western Digital', 'SSD-298', '2TB', '2.5"', 'PCIe 5.0', 6986, 1400, true, 56.01, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (30, 'Sabrent', 'SSD-351', '250GB', 'U.2', 'PCIe 3.0', 2132, 2833, false, 156.85, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (31, 'ADATA', 'SSD-439', '1TB', 'U.2', 'PCIe 5.0', 2177, 2447, true, 286.29, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (32, 'Western Digital', 'SSD-266', '2TB', '2.5"', 'PCIe 4.0', 6712, 1848, true, 141.08, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (33, 'Western Digital', 'SSD-933', '250GB', 'U.2', 'PCIe 3.0', 6071, 6420, true, 89.99, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (34, 'Western Digital', 'SSD-458', '2TB', 'M.2', 'PCIe 3.0', 4679, 3203, true, 58.88, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (35, 'Sabrent', 'SSD-450', '2TB', 'M.2', 'PCIe 3.0', 1874, 856, true, 328.70, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (36, 'ADATA', 'SSD-910', '250GB', '2.5"', 'PCIe 5.0', 3559, 3518, false, 332.44, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (37, 'ADATA', 'SSD-970', '2TB', 'M.2', 'PCIe 5.0', 3860, 3086, false, 264.37, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (38, 'ADATA', 'SSD-489', '2TB', 'M.2', 'PCIe 5.0', 7337, 2329, false, 283.22, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (39, 'Sabrent', 'SSD-709', '1TB', 'M.2', 'PCIe 3.0', 4044, 1025, true, 129.11, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (40, 'Samsung', 'SSD-148', '500GB', '2.5"', 'PCIe 3.0', 3532, 1629, true, 67.11, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (41, 'Crucial', 'SSD-790', '500GB', '2.5"', 'PCIe 5.0', 5310, 3704, false, 177.48, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (42, 'Western Digital', 'SSD-960', '2TB', 'M.2', 'PCIe 3.0', 4907, 2334, true, 133.71, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (43, 'Sabrent', 'SSD-408', '2TB', 'U.2', 'PCIe 3.0', 6003, 4381, true, 60.66, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (44, 'Sabrent', 'SSD-188', '2TB', '2.5"', 'PCIe 3.0', 4883, 2230, false, 72.74, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (45, 'Samsung', 'SSD-872', '2TB', '2.5"', 'PCIe 5.0', 7451, 3804, true, 87.69, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (46, 'Crucial', 'SSD-374', '250GB', 'U.2', 'PCIe 4.0', 6216, 6456, false, 285.60, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (47, 'Crucial', 'SSD-477', '500GB', '2.5"', 'PCIe 4.0', 1659, 6611, false, 215.40, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (48, 'ADATA', 'SSD-667', '500GB', 'M.2', 'PCIe 5.0', 6189, 6340, false, 240.18, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (49, 'Crucial', 'SSD-857', '250GB', 'M.2', 'PCIe 4.0', 4259, 1900, true, 89.64, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (50, 'Sabrent', 'SSD-304', '250GB', '2.5"', 'PCIe 4.0', 1206, 4662, true, 304.28, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (51, 'Western Digital', 'SSD-658', '250GB', 'U.2', 'PCIe 3.0', 5890, 3308, true, 47.89, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (52, 'Samsung', 'SSD-102', '250GB', '2.5"', 'PCIe 3.0', 3455, 3226, false, 165.41, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (53, 'Crucial', 'SSD-390', '500GB', 'M.2', 'PCIe 4.0', 5911, 4143, false, 325.13, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (54, 'Crucial', 'SSD-283', '1TB', '2.5"', 'PCIe 5.0', 2874, 3276, false, 160.83, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (55, 'Crucial', 'SSD-144', '1TB', '2.5"', 'PCIe 3.0', 3906, 1685, false, 121.92, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (56, 'ADATA', 'SSD-429', '500GB', 'M.2', 'PCIe 4.0', 1778, 3419, false, 154.78, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (57, 'ADATA', 'SSD-464', '1TB', '2.5"', 'PCIe 3.0', 3644, 2731, false, 324.09, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (58, 'Western Digital', 'SSD-321', '500GB', '2.5"', 'PCIe 3.0', 1427, 1245, true, 65.77, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (59, 'Sabrent', 'SSD-814', '1TB', '2.5"', 'PCIe 4.0', 6614, 5285, true, 242.81, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (60, 'ADATA', 'SSD-385', '2TB', '2.5"', 'PCIe 4.0', 7419, 1879, false, 176.16, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (61, 'Western Digital', 'SSD-646', '2TB', '2.5"', 'PCIe 5.0', 2361, 4870, false, 208.88, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (62, 'Sabrent', 'SSD-195', '500GB', '2.5"', 'PCIe 4.0', 6075, 6675, true, 244.11, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (63, 'Western Digital', 'SSD-518', '1TB', '2.5"', 'PCIe 5.0', 4442, 3616, true, 231.94, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (64, 'Crucial', 'SSD-325', '250GB', 'M.2', 'PCIe 5.0', 6336, 2065, false, 309.98, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (65, 'Western Digital', 'SSD-555', '250GB', 'U.2', 'PCIe 3.0', 6221, 3125, true, 155.12, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (66, 'Samsung', 'SSD-640', '500GB', '2.5"', 'PCIe 4.0', 6433, 1650, true, 336.89, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (67, 'Samsung', 'SSD-791', '250GB', 'M.2', 'PCIe 3.0', 5216, 2793, false, 239.03, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (68, 'Sabrent', 'SSD-645', '2TB', '2.5"', 'PCIe 3.0', 2317, 2335, true, 247.99, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (69, 'Sabrent', 'SSD-537', '2TB', 'M.2', 'PCIe 4.0', 4749, 4136, false, 248.30, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (70, 'Western Digital', 'SSD-463', '250GB', '2.5"', 'PCIe 4.0', 5509, 1302, false, 171.30, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (71, 'Crucial', 'SSD-929', '250GB', 'U.2', 'PCIe 4.0', 5916, 3353, true, 229.06, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (72, 'Samsung', 'SSD-585', '500GB', '2.5"', 'PCIe 3.0', 2300, 2015, false, 224.54, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (73, 'Sabrent', 'SSD-681', '500GB', '2.5"', 'PCIe 5.0', 6170, 3022, false, 193.29, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (74, 'Western Digital', 'SSD-993', '500GB', 'U.2', 'PCIe 4.0', 5876, 1756, true, 127.40, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (75, 'Samsung', 'SSD-386', '500GB', 'M.2', 'PCIe 5.0', 2723, 2733, false, 111.17, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (76, 'ADATA', 'SSD-437', '250GB', '2.5"', 'PCIe 4.0', 6787, 1642, false, 246.36, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (77, 'ADATA', 'SSD-964', '500GB', 'U.2', 'PCIe 5.0', 5924, 2991, true, 210.87, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (78, 'Samsung', 'SSD-411', '1TB', 'U.2', 'PCIe 3.0', 6476, 1882, false, 269.01, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (79, 'ADATA', 'SSD-837', '250GB', 'M.2', 'PCIe 3.0', 3987, 3778, false, 338.13, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (80, 'Sabrent', 'SSD-328', '1TB', '2.5"', 'PCIe 3.0', 5179, 3001, false, 73.51, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (81, 'Western Digital', 'SSD-381', '500GB', 'U.2', 'PCIe 5.0', 7363, 3691, true, 117.21, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (82, 'Western Digital', 'SSD-257', '2TB', 'U.2', 'PCIe 4.0', 1643, 5440, false, 66.83, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (83, 'Crucial', 'SSD-348', '2TB', '2.5"', 'PCIe 4.0', 4821, 5693, true, 95.42, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (84, 'Samsung', 'SSD-522', '2TB', '2.5"', 'PCIe 3.0', 6272, 7000, false, 233.21, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (85, 'Western Digital', 'SSD-686', '1TB', '2.5"', 'PCIe 3.0', 5907, 2111, false, 248.70, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (86, 'Crucial', 'SSD-432', '1TB', 'M.2', 'PCIe 5.0', 1805, 4925, true, 227.02, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (87, 'Western Digital', 'SSD-367', '500GB', '2.5"', 'PCIe 4.0', 3208, 6734, false, 112.90, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (88, 'Sabrent', 'SSD-828', '1TB', 'M.2', 'PCIe 3.0', 5266, 854, true, 225.60, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (89, 'Sabrent', 'SSD-993', '250GB', 'U.2', 'PCIe 4.0', 2619, 4930, true, 86.53, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (90, 'Crucial', 'SSD-730', '500GB', 'U.2', 'PCIe 3.0', 2522, 3453, true, 140.41, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (91, 'Sabrent', 'SSD-547', '1TB', 'M.2', 'PCIe 5.0', 6040, 4470, false, 316.32, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (92, 'Crucial', 'SSD-155', '500GB', '2.5"', 'PCIe 5.0', 6215, 3531, true, 73.30, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (93, 'Samsung', 'SSD-677', '2TB', 'U.2', 'PCIe 5.0', 3143, 6083, false, 45.29, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (94, 'Sabrent', 'SSD-648', '2TB', '2.5"', 'PCIe 3.0', 1433, 5254, true, 108.88, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (95, 'Samsung', 'SSD-489', '250GB', 'M.2', 'PCIe 3.0', 5361, 5674, true, 127.95, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (96, 'Crucial', 'SSD-605', '500GB', '2.5"', 'PCIe 5.0', 1240, 4511, true, 265.43, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (97, 'Samsung', 'SSD-588', '250GB', 'U.2', 'PCIe 4.0', 4763, 6912, false, 295.86, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (98, 'Crucial', 'SSD-175', '1TB', '2.5"', 'PCIe 5.0', 6128, 3313, true, 113.70, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (99, 'ADATA', 'SSD-821', '2TB', 'M.2', 'PCIe 5.0', 2407, 6901, true, 314.91, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (100, 'ADATA', 'SSD-747', '2TB', 'U.2', 'PCIe 4.0', 6388, 2830, true, 344.63, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (101, 'ADATA', 'SSD-474', '1TB', 'M.2', 'PCIe 5.0', 4075, 3238, false, 316.75, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (102, 'Samsung', 'SSD-884', '2TB', '2.5"', 'PCIe 4.0', 4808, 3664, false, 245.92, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (103, 'Crucial', 'SSD-219', '2TB', 'U.2', 'PCIe 5.0', 3655, 4295, true, 63.07, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (104, 'Samsung', 'SSD-602', '250GB', 'M.2', 'PCIe 4.0', 3612, 3712, true, 233.87, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (105, 'Crucial', 'SSD-941', '250GB', 'M.2', 'PCIe 5.0', 6317, 2222, true, 132.67, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (106, 'Crucial', 'SSD-929', '1TB', '2.5"', 'PCIe 5.0', 6147, 6996, true, 243.04, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (107, 'ADATA', 'SSD-249', '500GB', 'M.2', 'PCIe 5.0', 5109, 1175, true, 57.68, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (108, 'Crucial', 'SSD-732', '2TB', 'U.2', 'PCIe 5.0', 1625, 5645, true, 183.94, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (109, 'Western Digital', 'SSD-135', '2TB', 'M.2', 'PCIe 4.0', 3214, 4928, false, 166.04, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (110, 'Crucial', 'SSD-707', '2TB', 'U.2', 'PCIe 5.0', 4776, 2477, true, 335.90, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (111, 'Samsung', 'SSD-321', '1TB', '2.5"', 'PCIe 4.0', 6056, 1843, true, 240.61, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (112, 'Sabrent', 'SSD-277', '1TB', 'U.2', 'PCIe 5.0', 4950, 1446, true, 111.43, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (113, 'Sabrent', 'SSD-479', '250GB', 'U.2', 'PCIe 3.0', 6006, 1920, true, 129.88, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (114, 'Samsung', 'SSD-163', '2TB', 'U.2', 'PCIe 5.0', 5768, 3472, true, 279.45, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (115, 'ADATA', 'SSD-517', '500GB', 'U.2', 'PCIe 3.0', 5123, 1012, false, 270.20, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (116, 'Sabrent', 'SSD-551', '2TB', '2.5"', 'PCIe 4.0', 2545, 3224, false, 174.75, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (117, 'ADATA', 'SSD-716', '2TB', 'U.2', 'PCIe 4.0', 6651, 4285, false, 238.90, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (118, 'Crucial', 'SSD-784', '1TB', 'U.2', 'PCIe 3.0', 6932, 6984, false, 273.19, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (119, 'Crucial', 'SSD-212', '250GB', '2.5"', 'PCIe 5.0', 5343, 2257, false, 146.24, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (120, 'ADATA', 'SSD-469', '2TB', 'U.2', 'PCIe 3.0', 2030, 5243, true, 163.85, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (121, 'Samsung', 'SSD-415', '1TB', 'M.2', 'PCIe 4.0', 3309, 2647, true, 274.34, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (122, 'Sabrent', 'SSD-208', '250GB', '2.5"', 'PCIe 3.0', 5088, 4885, false, 319.14, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (123, 'ADATA', 'SSD-261', '2TB', '2.5"', 'PCIe 5.0', 4393, 991, true, 53.17, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (124, 'Samsung', 'SSD-277', '1TB', 'U.2', 'PCIe 5.0', 6526, 3653, false, 119.47, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (125, 'Samsung', 'SSD-271', '250GB', 'M.2', 'PCIe 3.0', 7358, 890, false, 242.91, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (126, 'Sabrent', 'SSD-478', '250GB', 'U.2', 'PCIe 4.0', 3603, 2773, false, 171.03, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (127, 'Sabrent', 'SSD-152', '1TB', '2.5"', 'PCIe 5.0', 5503, 4157, false, 41.95, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (128, 'Samsung', 'SSD-581', '2TB', 'M.2', 'PCIe 5.0', 5617, 3991, false, 330.49, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (129, 'Samsung', 'SSD-910', '1TB', '2.5"', 'PCIe 3.0', 5139, 6635, false, 218.35, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (130, 'Samsung', 'SSD-501', '2TB', 'M.2', 'PCIe 4.0', 2543, 6312, true, 273.69, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (131, 'Crucial', 'SSD-420', '1TB', 'M.2', 'PCIe 4.0', 6572, 871, true, 163.52, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (132, 'Crucial', 'SSD-899', '1TB', '2.5"', 'PCIe 3.0', 2629, 6403, false, 142.69, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (133, 'ADATA', 'SSD-500', '1TB', 'U.2', 'PCIe 3.0', 7357, 1831, true, 48.75, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (134, 'Crucial', 'SSD-451', '2TB', 'M.2', 'PCIe 3.0', 2449, 6844, false, 171.29, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (135, 'Crucial', 'SSD-825', '250GB', 'U.2', 'PCIe 5.0', 2117, 4826, false, 47.49, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (136, 'Samsung', 'SSD-925', '500GB', '2.5"', 'PCIe 3.0', 1360, 1739, true, 114.93, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (137, 'ADATA', 'SSD-793', '1TB', 'M.2', 'PCIe 3.0', 4623, 4281, true, 105.23, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (138, 'Crucial', 'SSD-752', '250GB', '2.5"', 'PCIe 4.0', 4804, 6695, true, 148.07, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (139, 'Western Digital', 'SSD-533', '250GB', '2.5"', 'PCIe 4.0', 1848, 2159, false, 253.17, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (140, 'Sabrent', 'SSD-598', '2TB', 'U.2', 'PCIe 3.0', 5094, 1451, true, 341.02, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (141, 'Samsung', 'SSD-187', '500GB', 'M.2', 'PCIe 5.0', 5396, 1005, false, 196.36, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (142, 'Samsung', 'SSD-609', '2TB', 'M.2', 'PCIe 5.0', 7078, 2868, true, 209.68, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (143, 'Samsung', 'SSD-186', '1TB', 'M.2', 'PCIe 3.0', 3127, 1555, true, 100.20, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (144, 'ADATA', 'SSD-300', '500GB', 'M.2', 'PCIe 4.0', 4316, 2284, false, 125.67, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (145, 'Sabrent', 'SSD-483', '250GB', '2.5"', 'PCIe 3.0', 2823, 1670, false, 64.19, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (146, 'Samsung', 'SSD-928', '500GB', 'M.2', 'PCIe 5.0', 1159, 6394, true, 304.88, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (147, 'Samsung', 'SSD-986', '2TB', 'M.2', 'PCIe 4.0', 4459, 4743, false, 150.91, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (148, 'ADATA', 'SSD-192', '250GB', '2.5"', 'PCIe 5.0', 1900, 1718, true, 175.08, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (149, 'Crucial', 'SSD-689', '500GB', 'M.2', 'PCIe 5.0', 3924, 1505, true, 95.09, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (150, 'Sabrent', 'SSD-423', '500GB', 'U.2', 'PCIe 3.0', 6417, 5639, false, 176.85, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (151, 'Crucial', 'SSD-327', '1TB', 'M.2', 'PCIe 4.0', 7087, 6135, true, 228.52, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (152, 'ADATA', 'SSD-104', '1TB', '2.5"', 'PCIe 5.0', 5109, 7000, true, 49.95, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (153, 'ADATA', 'SSD-157', '2TB', 'M.2', 'PCIe 3.0', 5040, 4885, false, 79.25, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (154, 'Sabrent', 'SSD-440', '2TB', '2.5"', 'PCIe 3.0', 1632, 1715, false, 93.32, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (155, 'Crucial', 'SSD-461', '2TB', 'M.2', 'PCIe 4.0', 3564, 3773, true, 98.33, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (156, 'Western Digital', 'SSD-309', '2TB', 'U.2', 'PCIe 4.0', 5507, 6784, false, 110.21, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (157, 'Western Digital', 'SSD-952', '2TB', 'M.2', 'PCIe 4.0', 7476, 965, true, 294.60, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (158, 'Western Digital', 'SSD-255', '250GB', 'U.2', 'PCIe 3.0', 6965, 1755, false, 227.62, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (159, 'Samsung', 'SSD-311', '250GB', '2.5"', 'PCIe 3.0', 2133, 6781, true, 56.62, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (160, 'Crucial', 'SSD-848', '2TB', '2.5"', 'PCIe 4.0', 4064, 4891, false, 254.44, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (161, 'ADATA', 'SSD-961', '1TB', 'U.2', 'PCIe 5.0', 5613, 1568, true, 73.03, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (162, 'Western Digital', 'SSD-822', '2TB', 'U.2', 'PCIe 5.0', 2410, 4530, false, 343.76, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (163, 'Crucial', 'SSD-878', '500GB', '2.5"', 'PCIe 5.0', 1232, 6557, true, 153.39, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (164, 'Western Digital', 'SSD-379', '2TB', '2.5"', 'PCIe 5.0', 4238, 5801, false, 149.00, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (165, 'Samsung', 'SSD-489', '500GB', '2.5"', 'PCIe 3.0', 4000, 1673, false, 189.29, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (166, 'Western Digital', 'SSD-280', '500GB', 'M.2', 'PCIe 3.0', 3397, 6187, false, 208.56, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (167, 'Samsung', 'SSD-741', '500GB', 'M.2', 'PCIe 5.0', 6953, 5904, true, 290.79, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (168, 'ADATA', 'SSD-990', '1TB', 'M.2', 'PCIe 4.0', 6240, 5920, false, 77.11, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (169, 'Sabrent', 'SSD-125', '2TB', '2.5"', 'PCIe 3.0', 2302, 3680, false, 149.54, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (170, 'ADATA', 'SSD-784', '1TB', '2.5"', 'PCIe 4.0', 4272, 873, false, 244.74, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (171, 'Crucial', 'SSD-549', '2TB', 'M.2', 'PCIe 4.0', 3515, 2230, true, 67.37, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (172, 'Sabrent', 'SSD-285', '500GB', 'U.2', 'PCIe 4.0', 2281, 1884, true, 232.92, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (173, 'Samsung', 'SSD-542', '1TB', '2.5"', 'PCIe 3.0', 5991, 4685, true, 134.16, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (174, 'ADATA', 'SSD-593', '250GB', 'U.2', 'PCIe 3.0', 3796, 3217, false, 133.21, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (175, 'Samsung', 'SSD-808', '1TB', 'U.2', 'PCIe 4.0', 3239, 2022, true, 106.33, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (176, 'Western Digital', 'SSD-952', '2TB', 'U.2', 'PCIe 4.0', 1441, 6423, false, 318.66, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (177, 'ADATA', 'SSD-142', '250GB', 'U.2', 'PCIe 4.0', 3565, 5550, true, 88.76, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (178, 'Samsung', 'SSD-575', '500GB', '2.5"', 'PCIe 3.0', 1601, 6834, true, 186.78, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (179, 'Samsung', 'SSD-657', '250GB', 'M.2', 'PCIe 4.0', 5348, 2383, false, 50.76, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (180, 'Crucial', 'SSD-494', '1TB', '2.5"', 'PCIe 3.0', 1018, 2137, false, 199.63, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (181, 'Samsung', 'SSD-281', '1TB', 'M.2', 'PCIe 5.0', 5541, 2691, true, 238.75, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (182, 'Samsung', 'SSD-832', '1TB', '2.5"', 'PCIe 5.0', 2407, 5188, true, 131.83, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (183, 'ADATA', 'SSD-701', '250GB', 'U.2', 'PCIe 3.0', 5820, 6942, true, 99.70, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (184, 'ADATA', 'SSD-604', '250GB', 'M.2', 'PCIe 3.0', 2764, 6457, false, 163.18, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (185, 'ADATA', 'SSD-546', '1TB', '2.5"', 'PCIe 4.0', 4333, 6825, true, 178.23, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (186, 'ADATA', 'SSD-583', '500GB', 'U.2', 'PCIe 3.0', 6677, 6119, true, 121.34, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (187, 'Crucial', 'SSD-325', '2TB', 'M.2', 'PCIe 3.0', 3425, 4895, false, 109.74, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (188, 'Crucial', 'SSD-382', '2TB', 'M.2', 'PCIe 4.0', 2898, 1407, false, 320.39, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (189, 'ADATA', 'SSD-607', '500GB', 'U.2', 'PCIe 4.0', 2310, 1238, false, 207.37, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (190, 'Samsung', 'SSD-136', '1TB', 'M.2', 'PCIe 4.0', 3697, 1629, false, 244.56, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (191, 'ADATA', 'SSD-421', '2TB', '2.5"', 'PCIe 5.0', 6155, 5010, false, 270.64, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (192, 'ADATA', 'SSD-994', '500GB', '2.5"', 'PCIe 5.0', 7184, 4779, true, 167.45, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (193, 'Samsung', 'SSD-781', '2TB', 'M.2', 'PCIe 3.0', 7345, 2410, false, 41.43, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (194, 'Crucial', 'SSD-142', '500GB', 'M.2', 'PCIe 4.0', 2829, 5157, false, 63.15, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (195, 'Crucial', 'SSD-910', '2TB', '2.5"', 'PCIe 5.0', 3390, 4393, false, 51.29, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (196, 'Crucial', 'SSD-809', '2TB', '2.5"', 'PCIe 4.0', 6793, 6308, false, 223.96, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (197, 'Samsung', 'SSD-469', '2TB', 'U.2', 'PCIe 3.0', 6981, 2123, false, 339.54, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (198, 'Sabrent', 'SSD-630', '250GB', '2.5"', 'PCIe 3.0', 1096, 6080, true, 272.76, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (199, 'Sabrent', 'SSD-158', '2TB', 'U.2', 'PCIe 3.0', 3108, 3746, false, 91.95, 'https://example.com/ssd');
INSERT INTO public.ssd VALUES (200, 'ADATA', 'SSD-587', '250GB', 'M.2', 'PCIe 5.0', 3537, 5346, true, 137.81, 'https://example.com/ssd');
...
--
-- Data for Name: saved_builds; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Name: casing_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: cpu_cooler_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: cpu_new_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: gpu_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: motherboard_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: psu_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: ram_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: saved_builds_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.saved_builds_id_seq', 1, true);


--
-- Name: ssd_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
